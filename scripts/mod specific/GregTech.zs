...
<recipemap:large_chemical_reactor>.recipeBuilder() .EUt(480) .inputs(<metaitem:ingotPlutonium> * 64, <metaitem:dustUranium>*8) .fluidInputs(<liquid:air> * 80000) .fluidOutputs(<liquid:radon>*8000) .outputs(<gregtech:meta_dust:81>*64) .duration(400) .buildAndRegister();
